        ...
        hover:before:rotate-6 hover:before:scale-105"
            >
                ...
                <div className="prose text-l xl:text-xl my-auto w-[80%] mx-auto md:w-[50%] md:mx-0">
                    <h3 className="font-bold text-primary-500">Hello, Ankara Science fellow!</h3>
                    <p>
                        If you are seeking senior help for{" "}
                        <span className="font-semibold text-secondary-300">modern</span> technologies and tools, you've
                ...
                <div className="prose text-l xl:text-xl my-auto w-[80%] mx-auto md:w-[50%] md:mx-0">
                    ...
                    <p>
                        <ul className="list-disc leading-tight">
                            <li>
                                Benefit our wide and <span className="font-semibold text-secondary-300">modern</span>{" "}
                                tutorial library.
                            </li>
                            <li>
                                Take mentorship from <span className="font-semibold text-primary-200">experienced</span>{" "}
                                seniors.
                            </li>
                        </ul>
                    </p>
                    <p>
                        Every student from preparation school to 4th grade is accepted, independent from the department.{" "}
                    </p>
                </div>
            </div>
        </>
